# unified_astro_logger_v7.py: Automates observatory logging, calibration, and monitoring workflows
# John Phillips
# john.d.phillips@comcast.net
# Version 7 - 2024-06-08
# Removed I filter from my filter wheel and added UV/IR-Cut filter with letter code L
# 
# Sections:
# - imports
# - global_setup
